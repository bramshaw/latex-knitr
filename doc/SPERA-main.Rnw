...
\newcommand{\rfile}{SPERA-main.r}
\newcommand{\texfile}{SPERA-main.tex}
\newcommand{\rnwexamplefile}{SPERA-main.Rnw}
...
if(use.binary.envir){
  ...
  source("./r/SPERA-main.r")
  #source("./r/CDFquantiles.r")
}
@
