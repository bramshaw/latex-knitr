...
make.cdfquant.table(species,## The output of the load catches function above.
                  ...
                  xcaption = "Cumulative distribution function quantiles for survey temperature-weighted catch.", ## Caption to use
...
%\begin{figure}[!htp]
%\begin{center}
%\includegraphics[width=6in,keepaspectratio=true]{FILENAME HERE.eps}
%\end{center}
%\caption{Mean ocean depth (m) in grid cells of 3 km x 3 km for based on BCMCA data.}
%\label{fig:allsurveysdepth}
%\end{figure}
