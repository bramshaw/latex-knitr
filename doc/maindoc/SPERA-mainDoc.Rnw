...
%%%CDF Quantile table
%<<make.cdfquant.table, results='asis', echo=FALSE>>=
%make.cdfquant.table(species,## The output of the load catches function above.
%                  digits, ## number of digits to show
%                  xcaption = "Cumulative distribution function %quantiles", ## Caption to use
